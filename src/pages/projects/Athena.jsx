...
const Athena = ({ className = 'athena', id = 'athena' }) => (
    <section className={className} id={id}>
      ...
      <img className={`${className}__paletteimg`} src="../src/assets/athena_palette.svg" alt=""/>
      <p className={`${className}__typography`}>typography</p>
      <div className={`${className}__fonts`}>
        <img className={`${className}__fonts__titleimg`} src="../src/assets/athena_title.svg" alt=""/>
        <img className={`${className}__fonts__bodyimg`} src="../src/assets/athena_body.svg" alt=""/>
      </div>
      <p className={`${className}__sketch`}>wireframes</p>
      <div className={`${className}__sketches1`}>
        <img className={`${className}__sketches1__sketch1`} src="../src/assets/sketch_home.png" alt=""/>
        <img className={`${className}__sketches1__sketch2`} src="../src/assets/sketch_feed.png" alt=""/>
      </div>
      <div className={`${className}__sketches2`}>
        <img className={`${className}__sketches2__sketch3`} src="../src/assets/sketch_task.png" alt=""/>
        <img className={`${className}__sketches2__sketch4`} src="../src/assets/sketch_gacha.png" alt=""/>
      </div>
      <p className={`${className}__illustration`}>illustrations</p>
      <img className={`${className}__background`} src="../src/assets/athena_background.png" alt=""/>
      <div className={`${className}__characters`}>
        <img className={`${className}__characters__1`} src="../src/assets/character_1.png" alt=""/>
        <img className={`${className}__characters__2`} src="../src/assets/character_2.png" alt=""/>
        <img className={`${className}__characters__3`} src="../src/assets/character_3.png" alt=""/>
      </div>
      <p className={`${className}__prototype`}>prototype</p>
      <img className={`${className}__homeimg`} src="../src/assets/athena_home.png" alt=""/>
      <img className={`${className}__taskimg`} src="../src/assets/athena_task.png" alt=""/>
      <img className={`${className}__feedimg`} src="../src/assets/athena_feed.png" alt=""/>
      <img className={`${className}__gachaimg`} src="../src/assets/athena_gacha.png" alt=""/>
      <img className={`${className}__settingsimg`} src="../src/assets/athena_settings.png" alt=""/>
      ...
      <p className={`${className}__improvet`}>As the project is still unfinished, it has some areas that need more or less work. The tablet and mobile views are till only on a wireframe level and lack actual prototypes. When the project is finished I also hope to do some usability testing.</p>
